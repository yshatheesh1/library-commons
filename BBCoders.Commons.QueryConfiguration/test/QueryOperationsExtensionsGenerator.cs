...
// namespace BBCoders.Commons.QueryConfiguration.test
// {
//     public class QueryOperationsExtensionsGenerator
//     {
...
//             builder.AppendLine();
//             builder.AppendLine("namespace Test.Common.QueryGenerator");
//             builder.AppendLine("{");
//             using (builder.Indent())
//             {
//                 // geneate func with more than default 16 parameters
...
//                     s.Add("/// </summary>");
//                     s.Add("/// <param name=\"queryOperations\">query operations</param>");
...
//                         builder.AppendLine($"public static void Add<{genericExpression}>(this QueryOperations queryOperations, string name, Expression<Func<{genericExpression}, IQueryable>> expression) => queryOperations.Add(name, expression.Parameters.ToList(), expression);");
...
//             }
//             builder.AppendLine("}"); 
//             File.WriteAllText(Directory.GetCurrentDirectory() + "/testttt.cs", builder.ToString());
//         }
//     }
// }